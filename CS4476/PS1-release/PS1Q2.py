...
class Prob2():
    ...
    def prob_2_1(self):
        ...
        image = sorted_intensities.reshape(-1, 1)
        plt.figure()
        # Referred to https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.imshow.html
    ...
    def prob_2_2(self):
        ...
        ###### START CODE HERE ######
        plt.figure()
        plt.hist(self.A.reshape(-1), bins=20)
        plt.show()
        ###### END CODE HERE ######
        return
    ...
    def prob_2_4(self):
        ...
        Y = None
        ###### START CODE HERE ######
        # Referred to https://numpy.org/devdocs/reference/generated/numpy.mean.html
        mean_val = self.A.mean()
        Y = self.A - mean_val
        ###### END CODE HERE ######
        return Y
    ...
    def prob_2_5(self):
        ...
        Z = None
        ###### START CODE HERE ######
        threshold = self.A.mean()
        bigger = self.A > threshold
        height, width = self.A.shape
        Z = np.zeros((height, width, 3), dtype=float)
        Z[bigger, 0] = 1.0
        ###### END CODE HERE ######
        return Z
