...
def signed_point_line_errors(x_0s: list,
                             F: np.ndarray, 
                             x_1s: list) -> List[float]:
    ...
    for x_0, x_1 in zip(x_0s, x_1s):
        l_0 = F @ x_1
        l_1 = F.T @ x_0
        errors.append(point_line_distance(l_0, x_0))
        errors.append(point_line_distance(l_1, x_1))
    ##############################
...
def skew(x, y, z):
    ...
    return np.array([[0, -z, y], [z, 0, -x], [-y, x, 0]], np.float32)
